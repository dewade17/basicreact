    ...
    <Layout className="layout-default layout-signin">
      ...
      <Content className="signin login-container">
        <Row gutter={[24, 0]} justify="space-around">
          <Col className="sign-img" xs={{ span: 24 }} lg={{ span: 8, offset: 4 }} md={{ span: 12 }}>
            <img src={SignBG} alt="" />
      ...
      <Footer>
        <p className="copyright"> Copyright © 2024 WebfmSI.com - Powered by Universitas Pendidikan Ganesha</p>
      </Footer>
    </Layout>
  );
};
